...
<!-- 
3つあげているんですが、そのうちのCollaというものをご紹介させていただければと思っています
-->
...
<!-- 
先程も言ったとおり、CollaというSlackアプリのご紹介と、
あとは、宣伝だけだと...
いろいろSlack活用にまつわるノウハウを集めてきたので、そちらを共有させていただければと思います。
...
<!-- 
コミュニケーション減ってくるとなかなかチームの状況が見えないだとか、これまでオフィスでやっていたのと同様に仕事をしているとなかなかうまく行かなかったり、
-->
...
<!--
そんなコラなんですが、どうやって生まれたか、みたいな話をさせていただくと
今年の4月とか5月くらいに、皆さんも御存知コロナが猛威を奮って緊急事態宣言が発令されたと、
で、うちの会社も多分にもれず影響うけたんですけど、
これはこれで今しかできないことしたいよね、みたいな話になって
それが5月頭くらいすかね、
GW 一週間くらいでガッと企画・開発してリリースしたのが始まりでした
-->
...
<!--
全然広告とかも出してないんですけど
いまではかなり多くのWSで利用いただいてます

そんな Collaなんですが、リリースしてから少しずつマイナーアップデートはしてるんですが、
ちゃんと機能の紹介みたいなのをする機会がなかったところもあり、
すでに利用されてる方も、まだ利用されてない方にもいろいろとCollaの機能やオススメの使い方などをおナハシさせていただければと思います
-->
...
<!--
一応このあたりが現状のメインの機能になるんでが
せっかくなので今開発中の機能もちら見せさせてください
 -->
...
<!--
詳細は秘密なんですが、飴ちゃんを通じてチームのコンディションをよりよくする、みたいなものいまこっそり計画してたりします。
-->
...
<!--
なんか偉そうに行ってますが、
僕はどっちかというと作るの専門で、開発に関してのTipsとかは死ぬほどあるんですけど
Slack活用に関するノウハウっていうとなんともいえず、
こういった場にこられるかたはさぞいろんなノウハウもってて
そんじょそこらの話だと全然刺さらないのではないかと内心ビクビクしてるんですが
ほどよい期待値でお楽しみいただければと思います
-->
...
<!--
小一時間でぴゃっと作った割にはなかなか効果あったのでオススメです

つづいては Notion unfurl botをご紹介します
-->
...
<!--
シンプルにSlack に貼り付けた Private な notion のリンクの中身を展開する botです
で、多分似たようなことされてる方も多いんじゃないかと思んですが
なんでこんなもの作ろうと思ったかというと
-->
...
<!--
当然なんですが、いちいち URL 開かなくても概要が把握できるのでシンプルに楽、
メッセージとかで、これ後で呼んどいてね、と言われるだけだと正直後回しにしてしまうんですが
ぱっとみて重要そうであれば積極的に中身みたくなるので、そういったところでもぜんぜん違う

あと地味に大きいところでいうと、リンクの視認性が上がるのであとから見返したときに見つけやすい
あとからあれどこで共有されたっけみたいなのをSlackの検索から遡ろうとしてもリンクだけだとまじできついんですが、
中身見えてると結構さくっとみつかってよいです

これもサクッと作ったわりにはなかなか効果あってよかったです

で、一応エンジニアの方対象ということで少しだけ技術的な話すると、
-->
...
<!--
昔はメッセージパースしてURL探して、とかやってたりしてた方もいるんじゃないかと思うんですが、
現在はlink展開用の機能があるので、こういったものを利用するとさっきのような認証必要なリンクの展開みたいなのが比較的簡単にできるのでオススメです。
-->
...
<!--
で、一応コードものせてあるので興味あれば参考にしていただければと思います。
あまり人に見せる前提でつくってなかったのをイベント用に多少いじったので
もし壊れていたりしたら申し訳ありません...
PRなどいただければと思います。

それではうちの会社の話はこれくらいにして次は
-->
...
<!--
先程あげたようにめちゃくちゃ小さな組織なんですが、副業で手伝って頂いてる方は
どことは言わないですがつい最近上場したところの方とか有名企業で働いてるかたが多く、
いろいろノウハウ持ってらっしゃるんじゃないかと思っていろいろ聞いてきました

そのあたりの細かいTipsも共有させていただきます。
-->
